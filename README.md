...
| `… scripts/migrate-content.mjs --only=<step>` | Run **one** backfill: `carousel`, `pages`, `seo`, `headings`, `strategy`, `header-button`, `nav-labels`, `chrome-labels`, `cta`. Prefer this after the initial load — see below |
