...
Third and final handover of 2026-09-16, and the one to read first of the three.
...
| this file | `f7add71` and `dc03782` |

Deployed at `dc03782` and verified on the live site.
